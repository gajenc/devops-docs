...
## Application Deployment Model <a id="application-deployment-model"></a>
...
## Service Discovery & Load Balancing <a id="service-discovery-and-load-balancing"></a>
...
## Internal/External Routing Separation <a id="internal-external-routing-separation"></a>
...
## Usage of Persistent Volumes <a id="usage-of-persistent-volumes"></a>
...
## Deploying Daemons on Nodes <a id="deploying-daemons-on-nodes"></a>
...
## Deploying Stateful Distributed Systems <a id="deploying-stateful-distributed-systems"></a>
...
## Running Background Jobs <a id="running-background-jobs"></a>
...
## Deploying Databases <a id="deploying-databases"></a>
...
## Configurations Management <a id="configurations-management"></a>
...
## Credentials Management <a id="credentials-management"></a>
...
## Rolling Out Updates <a id="rolling-out-updates"></a>
